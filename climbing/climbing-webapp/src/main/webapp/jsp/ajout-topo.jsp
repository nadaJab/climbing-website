...
<body>
	...
	<div class="container">
		...
		<s:form action="index" enctype="multipart/form-data"
			...
			<s:textfield key="nameTopo" tooltip="Entrer le nom du Topo" />

			<s:textfield key="author" tooltip="Entrer l'auteur du topo" />

			<s:textfield key="nbCopyMax"
				tooltip="Donner le nombre d'exemplaires que vous disposez" />

			<s:textfield key="editionYear" tooltip="L'année d'édition du topo" />
